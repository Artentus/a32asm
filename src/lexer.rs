...
const KEYWORD_MAP: &[(&str, Keyword)] = &[
    ...
    ("brl.s"   , Keyword::BrlS   ),
    ("brl.o"   , Keyword::BrlO   ),
    ("brl.nc"  , Keyword::BrlNc  ),
    ("brl.nz"  , Keyword::BrlNz  ),
    ("brl.ns"  , Keyword::BrlNs  ),
    ("brl.no"  , Keyword::BrlNo  ),
    ("brl.eq"  , Keyword::BrlEq  ),
    ("brl.neq" , Keyword::BrlNeq ),
    ("brl.u.l" , Keyword::BrlUL  ),
    ("brl.u.ge", Keyword::BrlUGe ),
    ("brl.u.le", Keyword::BrlULe ),
    ("brl.u.g" , Keyword::BrlUG  ),
    ("brl.s.l" , Keyword::BrlSL  ),
    ("brl.s.ge", Keyword::BrlSGe ),
    ("brl.s.le", Keyword::BrlSLe ),
    ("brl.s.g" , Keyword::BrlSG  ),
    ("jrl"     , Keyword::Jrl    ),
